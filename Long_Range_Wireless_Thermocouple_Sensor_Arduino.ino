   ...
   if(data[0]==0x7E)
{
  ...
  if(data[22]==4)  //////// make sure the sensor type is correct
{ 
  Serial.println("Long Range Wireless Therocouple Sensor "); 
  byte low_temp = data[24] & 0x80;
  if(low_temp)
  {
    float temp = ((data[24]*16) + data[25]/16);
    cTemp = temp - 4096;
  }
  else
  {
    data[24] = data[24]*16;
    data[25] = data[25]*0.0625;
    cTemp = data[24]+ data[25]; ;
  }
